...
var queue_worker_1 = require("./queue-worker");
var debugLog = path.resolve(sumanHome + '/logs/suman-postinstall-debug.log');
var cwd = process.cwd();
...
var logInfo = function () {
    ...
    var data = Array.from(args).map(function (v) { return String(v); }).join(' ');
    try {
