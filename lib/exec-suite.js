...
var test_suite_1 = require("./test-suite-helpers/test-suite");
...
exports.execSuite = function (suman) {
    ...
    var createInjector = suman_methods_1.makeSumanMethods(suman, gracefulExit, handleBeforesAndAfters, notifyParent);
    ...
    return function runRootSuite($$desc, $$opts) {
        ...
        var suite = new test_suite_1.TestBlock({ desc: desc, isTopLevel: true, opts: opts, suman: suman, gracefulExit: gracefulExit, handleBeforesAndAfters: handleBeforesAndAfters, notifyParent: notifyParent });
