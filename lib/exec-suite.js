...
var general_4 = require("./helpers/general");
...
exports.execSuite = function (suman) {
    ...
    var blockInjector = suman_methods_1.makeSumanMethods(suman, TestBlock, gracefulExit, notifyParent);
    ...
    return function runRootSuite() {
        ...
        var vetted = general_4.parseArgs(args);
