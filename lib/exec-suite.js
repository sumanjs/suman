        ...
        function makeSuite(desc, opts, cb, argz, writable, $ioc) {
            ...
            function start() {
                ...
                function runSuite(suite, cb) {
                    ...
                    fs.appendFileSync(global.testStderrStrmPath, 'runSuite!');

                    const fn = suite.parallel ? async.each : async.eachSeries;

                    suite.__startSuite(function (err, results) {

                        fs.appendFileSync(global.testStderrStrmPath, 'startSuite!');
                ...
                runSuite(allDescribeBlocks[0], function complete() {
                    ...
                    try {
                        ...
                        console.error('child error is almost done here!');

                        console.stdout('child error is almost done here!');
