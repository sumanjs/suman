...
if (_suman.inceptionLevel < 1) {
    _suman.log.info = log_prepend_1.lp(chalk.gray.bold(' [suman] '), process.stdout);
    _suman.log.good = log_prepend_1.lp(chalk.cyan.bold(' [suman] '), process.stdout);
    _suman.log.warning = log_prepend_1.lp(chalk.yellow(' [suman] '), process.stderr);
    _suman.log.error = log_prepend_1.lp(chalk.red(' [suman] '), process.stderr);
}
else {
