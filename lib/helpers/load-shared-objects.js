...
module.exports = function loadSharedObjects(pathObj, projectRoot) {
  ...
  try {
    ...
    console.error('\n',(sumanHelpersDirLocated ? colors.blue(' => Suman could successfully locate your "sumanHelpersDir", but...\n') : '')
      + colors.yellow.bold(' ...Suman could not find the /logs directory...you may have accidentally deleted it, ' +
