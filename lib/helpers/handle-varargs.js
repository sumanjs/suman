    ...
    args: [
      {
        type: 'string',
        required: true,
        errorMessage: 'First argument to describe/suite blocks must be a string description/title.\n' +
    ...
    args: [
      {
        type: 'string',
        required: false,
        errorMessage: 'First argument must be a string description/title for the hook.\n' +
