...
exports.makeDescribe = function (suman, gracefulExit, TestSuite, zuite, notifyParentThatChildIsComplete, blockInjector) {
    return function ($$desc, $opts) {
        ...
        var suite = new TestSuite({ desc: desc, title: desc, opts: opts });
        if (zuite.fixed) {
            suite.fixed = true;
        }
        ...
        var deps = fnArgs(cb);
        suite._run = function run(val, callback) {
