...
exports.makeDescribe = function (suman, gracefulExit, TestSuiteMaker, zuite, notifyParentThatChildIsComplete, blockInjector) {
    return function ($$desc, $opts) {
        ...
        var suite = TestSuiteMaker({ desc: desc, title: desc, opts: opts });
        if (zuite.fixed) {
            suite.fixed = true;
        }
