...
exports.makeDescribe = function (suman, gracefulExit, notifyParent, blockInjector, handleBeforesAndAfters) {
    return function describe($$desc, $opts) {
        ...
        var suite = new test_suite_1.TestBlock({ desc: desc, title: desc, opts: opts, suman: suman, notifyParent: notifyParent, handleBeforesAndAfters: handleBeforesAndAfters, gracefulExit: gracefulExit });
        if (zuite.fixed) {
            suite.fixed = true;
        }
