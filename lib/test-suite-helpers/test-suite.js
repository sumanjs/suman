...
var TestBlockBase = (function () {
    ...
    TestBlockBase.prototype.getInjections = function () {
        return this[exports.TestBlockSymbols.injections];
    };
    TestBlockBase.prototype.getChildren = function () {
        return this[exports.TestBlockSymbols.children];
    };
    TestBlockBase.prototype.getTests = function () {
        return this[exports.TestBlockSymbols.tests];
    };
    TestBlockBase.prototype.getParallelTests = function () {
        return this[exports.TestBlockSymbols.parallelTests];
    };
    TestBlockBase.prototype.getBefores = function () {
        return this[exports.TestBlockSymbols.befores];
    };
    TestBlockBase.prototype.getBeforeBlocks = function () {
        return this[exports.TestBlockSymbols.beforeBlocks];
    };
    TestBlockBase.prototype.getBeforesFirst = function () {
        return this[exports.TestBlockSymbols.beforesFirst];
    };
    TestBlockBase.prototype.getBeforesLast = function () {
        return this[exports.TestBlockSymbols.beforesLast];
    };
    TestBlockBase.prototype.getBeforeEaches = function () {
        return this[exports.TestBlockSymbols.beforeEaches];
    };
    TestBlockBase.prototype.getAftersFirst = function () {
        return this[exports.TestBlockSymbols.aftersFirst];
    };
    TestBlockBase.prototype.getAftersLast = function () {
        return this[exports.TestBlockSymbols.aftersLast];
    };
    TestBlockBase.prototype.getAfters = function () {
        return this[exports.TestBlockSymbols.afters];
    };
    TestBlockBase.prototype.getAfterBlocks = function () {
        return this[exports.TestBlockSymbols.afterBlocks];
    };
    TestBlockBase.prototype.getAfterEaches = function () {
        return this[exports.TestBlockSymbols.afterEaches];
    };
    TestBlockBase.prototype.getAfterBlockList = function () {
        var v = this, ret = [];
        while (v = v.parent) {
    ...
    TestBlockBase.prototype.getBeforeBlockList = function () {
        var v = this, ret = [];
        while (v = v.parent) {
    ...
    TestBlockBase.prototype.resume = function () {
    ...
    TestBlockBase.prototype.startSuite = function () {
        return this.__startSuite.apply(this, arguments);
    };
    TestBlockBase.prototype.toString = function () {
        return 'Suman test block: ' + this.desc;
    };
    TestBlockBase.prototype.invokeChildren = function (val, start) {
        async.eachSeries(this.getChildren(), makeRunChild(val), start);
    };
    TestBlockBase.prototype.bindExtras = function () {
        return this.__suitesuman.ctx = this;
    };
    TestBlockBase.prototype.mergeBefores = function () {
    ...
    TestBlockBase.prototype.mergeAfters = function () {
    ...
    TestBlockBase.prototype.getHooks = function () {
...
var TestBlock = (function (_super) {
    ...
    function TestBlock(obj) {
        ...
        _this.__suitesuman = suman;
        _this.__startSuite = make_start_suite_1.makeStartSuite(suman, gracefulExit, handleBeforesAndAfters, notifyParent);
        _this.opts = obj.opts;
        _this.testId = incr();
        ...
        _this[exports.TestBlockSymbols.beforeBlocks] = [];
        ...
        _this[exports.TestBlockSymbols.afterBlocks] = [];
