...
module.exports = function (suman, gracefulExit) {
    ...
    return function (self) {
        ...
        return function handleBeforesAndAfters(aBeforeOrAfter, cb) {
            ...
            const fini = helpers.makeCallback(d, null, timer, 'before/after', cb);
            ...
            d.run(function () {
                ...
                process.nextTick(function () {
                    ...
                    if (isGeneratorFn) {
                        ...
                        aBeforeOrAfter.apply(aBeforeOrAfter.ctx, args);  //TODO: correct?

                    }
                    else {

                        handlePotentialPromise(aBeforeOrAfter.apply(aBeforeOrAfter.ctx, args), warn);
