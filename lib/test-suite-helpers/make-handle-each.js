...
module.exports = function (suman, gracefulExit) {
    return function handleBeforeOrAfterEach(self, test, aBeforeOrAfterEach, cb) {
        ...
        if (test.skipped || test.stubbed) {
            ...
            var timerObj_1 = {
                timer: setTimeout(onTimeout_1, _suman.weAreDebugging ? 5000000 : aBeforeOrAfterEach.timeout)
            };
            var assertCount_1 = {
                num: 0
            };
            ...
            var fini_1 = makeCallback(d, assertCount_1, null, aBeforeOrAfterEach, timerObj_1, gracefulExit, cb);
            var fnStr_1 = aBeforeOrAfterEach.fn.toString();
            var dError_1 = false;
            ...
            d.run(function () {
                process.nextTick(function () {
                    ...
                    var HookObj = makeHookObj(aBeforeOrAfterEach, assertCount_1);
                    var t = new HookObj(handleError_1);
                    fini_1.th = t;
                    t.timeout = timeout;
                    t.data = test.data;
