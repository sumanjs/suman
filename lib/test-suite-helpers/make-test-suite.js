...
exports.makeTestSuiteMaker = function (suman, gracefulExit) {
    ...
    var TestSuiteMaker = function (data) {
        ...
        var TestSuite = function (obj) {
            ...
            describe = this.context = make_describe_1.makeDescribe(suman, gracefulExit, TestSuiteMaker, zuite, notifyParentThatChildIsComplete);
