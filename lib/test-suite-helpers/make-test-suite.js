...
exports.makeTestSuiteMaker = function (suman, gracefulExit, blockInjector) {
    ...
    var TestSuiteMaker = function (data) {
        ...
        TestSuite.prototype.__bindExtras = function bindExtras() {
            var ctx = suman.ctx = this;
            var getProxyOld = function (val, rule, props) {
            ...
            this.describe = getProxy(describe, rules.blockSignature);
            this.it = getProxy(it, rules.testCaseSignature);
            this.inject = getProxy(inject, rules.hookSignature);
            this.before = getProxy(before, rules.hookSignature);
            this.beforeEach = getProxy(beforeEach, rules.hookSignature);
            this.after = getProxy(after, rules.hookSignature);
            this.afterEach = getProxy(afterEach, rules.hookSignature);
        };
