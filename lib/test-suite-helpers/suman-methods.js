...
var make_before_block_1 = require("../test-suite-methods/make-before-block");
var make_after_block_1 = require("../test-suite-methods/make-after-block");
var possibleProps = {
    describe: true,
    beforeeach: true,
...
exports.makeSumanMethods = function (suman, gracefulExit, handleBeforesAndAfters, notifyParent) {
    ...
    var beforeEachBlock = addDefine(make_before_block_1.makeBeforeBlock(suman), define_options_classes_1.DefineObjectAllHook);
    var afterEachBlock = addDefine(make_after_block_1.makeAfterBlock(suman), define_options_classes_1.DefineObjectAllHook);
    ...
    var describe = addDefine(make_describe_1.makeDescribe(suman, gracefulExit, notifyParent, blockInjector, handleBeforesAndAfters), define_options_classes_1.DefineObjectContext);
