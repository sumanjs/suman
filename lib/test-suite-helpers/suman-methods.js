...
var DefineObject = (function () {
    ...
    DefineObject.prototype.events = function () {
    ...
    DefineObject.prototype.successEvents = function () {
        var args = [];
    ...
    DefineObject.prototype.successEvent = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    DefineObject.prototype.errorEvents = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    DefineObject.prototype.errorEvent = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
