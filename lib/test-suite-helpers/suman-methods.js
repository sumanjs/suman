...
exports.makeSumanMethods = function (suman, TestBlock, gracefulExit, notifyParent) {
    ...
    m.beforeeachblock = m.beforeeachchild = getProxy(beforeEachBlock, rules.hookSignature);
    m.aftereachblock = m.aftereachchild = getProxy(afterEachBlock, rules.hookSignature);
