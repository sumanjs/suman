...
exports.makeHandleTest = function (suman, gracefulExit) {
    return function _handleTest(self, test, cb) {
        ...
        d.run(function () {
            process.nextTick(function () {
                ...
                var TestCase = t_proto_test_1.makeTestCase(test, assertCount);
                var t = new TestCase(handleErr);
                fini.th = t;
                ...
                if (isGeneratorFn) {
                    ...
                    if (test.fn.call(self, args)) {
                        _suman._writeTestError(clone_error_1.cloneError(test.warningErr, constants.warnings.RETURNED_VAL_DESPITE_CALLBACK_MODE, true).stack);
                    }
                }
                else {
