...
var getHomeDir = require('./get-home-dir');
        ...
        createNewTestRun: function createNewTestRun(sumanConfig, serverName, cb) {
            ...
            tcpp.probe(server.host, server.port, function (err, avail) {
                ...
                if (err) {
                    ...
                    if (sumanConfig.servers.localhost && sumanConfig.servers.localhost.outputDir) {
                        try {
                            var dir = sumanConfig.servers.localhost.outputDir;  //TODO need to fix!!
