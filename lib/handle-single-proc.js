...
function sumanSingleProcessPre(cb) {
    ...
    const integrantsEmitter = global.integrantsEmitter;
    ...
    d.run(function () {
        process.nextTick(function () {
            acquireDeps(_.flattenDeep(global.oncePreKeys), depContainerObj, sumanUtils.onceAsync(global, function (err, vals) {
                if (err) {
