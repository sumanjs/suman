...
var run_file_1 = require("./multi-process/run-file");
var run_queue_1 = require("./multi-process/run-queue");
exports.makeHandleMultipleProcesses = function (runnerObj, tableRows, messages, forkedCPs, handleMessage, beforeExitRunOncePost, makeExit) {
    return function (runObj) {
        ...
        var onExitFn = multiple_process_each_on_exit_1.makeOnExitFn(runnerObj, tableRows, messages, forkedCPs, beforeExitRunOncePost, makeExit);
        var args = ['--user-args', sumanOpts.user_args];
        var runQueue = run_queue_1.makeRunQueue();
        var runFile = run_file_1.makeRunFile(runnerObj, args, runQueue, projectRoot, socket_cp_hash_1.cpHash, forkedCPs, onExitFn);
        ...
        var transpileQueue = transpile_queue_1.makeTranspileQueue(failedTransformObjects, runFile, queuedTestFns);
        if (waitForAllTranformsToFinish) {
