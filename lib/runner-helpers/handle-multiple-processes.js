                ...
                transpileQueue.push(function (cb) {
                    suman_utils_1.default.makePathExecutable(tr, function (err) {
                        ...
                        if (false) {
                            ...
                            var temp = suman_utils_1.default.removePath(file, _suman.projectRoot);
                ...
                if (n.stdio && n.stdout && n.stderr) {
                    ...
                    if (true || sumanOpts.$useTAPOutput) {
                        ...
                        n.stdout.pipe(getTapParser())
                            .on('error', function (e) {
                            _suman.logError('error parsing TAP output => ', suman_utils_1.default.getCleanErrorString(e));
                        });
                        n.stdout.pipe(getTapJSONParser())
                            .on('error', function (e) {
                            _suman.logError('error parsing TAP JSON output => ', suman_utils_1.default.getCleanErrorString(e));
                        })
