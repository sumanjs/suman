...
exports.makeAddToRunQueue = function (runnerObj, args, runQueue, projectRoot, cpHash, forkedCPs, onExitFn) {
    ...
    var handleRunDotShFile = handle_different_executables_1.makeHandleDifferentExecutables(projectRoot, sumanOpts).handleRunDotShFile;
    var childId = 1;
            ...
            if (sh) {
                ...
                if ('.js' === extname) {
                    if (sumanOpts.coverage) {
                        ...
                        var argzz = ['cover', execFile, '--dir', coverageDir, '--'].concat(args);
