...
if (process.env.SUMAN_DEBUG !== 'yes' && !global.sumanOpts.sparse) {
	setInterval(function () {
		setTimeout(function () {
			...
			console.log('\n\n', colors.bgCyan.white.bold(' => The following processes have started but not ended yet:'), colors.cyan(startedButNotEnded));
