...
exports.makeExit = function (runnerObj, tableRows) {
    return function (messages, timeDiff) {
        ...
        overallResultsTable.setHeading('Bailed?', 'Files ➣', '(Passed/Failed/Total)', 'Test cases ➣', 'Passed', 'Failed', 'Skipped', 'Stubbed', 'All Tests', 'Total Time');
        ...
        async.autoInject({
            ...
            handleAsyncReporters: function (cb) {
