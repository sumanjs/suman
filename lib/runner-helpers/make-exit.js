...
const create_gantt_chart_1 = require("./create-gantt-chart");
let timeOutMillis = 15000;
const mapCopy = function (copy) {
...
exports.makeExit = function (runnerObj, tableRows) {
    return function (messages, timeDiff) {
        ...
        async.autoInject({
            ...
            makeTimelineChart: function (cb) {
                create_gantt_chart_1.createTimelineChart(cb);
            },
