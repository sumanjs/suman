            ...
            task(function (err, file, shortFile, stdout, pathFromProjecRoot) {
                ...
                if (err) {
                    ...
                    failedTestObjects.push({
                        err: err, file: file, shortFile: shortFile, stdout: stdout, pathFromProjecRoot: pathFromProjecRoot
                    });
                }
                else {
                    queuedTestObjects.push({
                        file: file, shortFile: shortFile, stdout: stdout, pathFromProjecRoot: pathFromProjecRoot
                    });
                }
            });
        }, 4);
