            ...
            var run = function () {
                ...
                var runAfterAnyTransform = function (file, stdout) {
                    ...
                    if (n.stdio) {
                        ...
                        if (sumanOpts.inherit_stdio) {
                            n.stdout.pipe(prepend_transform_1.default(chalk.bold(' => [suman child stdout] => '))).pipe(process.stdout);
                            n.stderr.pipe(prepend_transform_1.default(chalk.red.bold(' => [suman child stderr] => '))).pipe(process.stderr);
                        }
                        if (sumanOpts.$useTAPOutput) {
                ...
                if (tr) {
                    ...
                    if (sumanOpts.inherit_stdio) {
                        ...
                        k_1.stdout.pipe(process.stdout);
                    }
                    var stdout_1 = '';
                    ...
                    k_1.once('close', function (code) {
                        if (code > 0) {
                            ...
                            runAfterAnyTransform(file, stdout_1);
                        }
                    });
                }
                else {
