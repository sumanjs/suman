...
exports.makeBeforeExit = function (runnerObj, oncePosts, allOncePostKeys) {
    return function beforeExitRunOncePost(cb) {
        ...
        var flattenedAllOncePostKeys = uniq(_.flattenDeep(allOncePostKeys));
        var args = fnArgs(runnerObj.oncePostModule);
        var postInjector = make_post_injector_1.makePostInjector(userData, null);
        ...
        acquire_post_deps_1.acquirePostDeps(keys, oncePosts).then(function () {
            console.log('\n');
