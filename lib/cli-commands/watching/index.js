...
exports.run = function (paths, sumanOpts, sumanConfig) {
    ...
    if (sumanOpts.watch_per) {
        ...
        assert(suman_utils_1.default.isObject(watchPer), chalk.red("Suman usage error => key \"" + sumanOpts.watch_per + "\" does not exist on the {suman.conf.js}.watch.per object."));
    }
