...
exports.run = function (sumanOpts, sumanConfig) {
    ...
    if (sumanOpts.watch_per) {
        ...
        assert(suman_utils_1.default.isObject(watchPer), colors.red(" => Suman usage error => key/value for key " + sumanOpts.watch_per + ", does not exist on {suman.conf.js}.watch.per.}"));
    }
    suman_watch_1.startWatching(Object.freeze({
        watchPer: watchPer,
