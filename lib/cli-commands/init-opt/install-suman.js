...
module.exports = function (data) {
  ...
  return function npmInstall(cb) {
    ...
    if (_suman.sumanOpts.no_install || resolvedLocal) {
      if (resolvedLocal) {
        console.log('\n\n');
        console.log(chalk.magenta(' => Suman is already installed locally ( v' + pkgDotJSON.version + '),' +
      ...
      envObj.SUMAN_POSTINSTALL_IS_DAEMON = _suman.sumanOpts.daemon ? 'yes' : undefined;
