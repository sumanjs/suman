...
const integrantsEmitter = global.integrantsEmitter = new EE();
const suiteResultEmitter = global.suiteResultEmitter = new EE();
const handleExtraOpts = require('./handle-extra-opts');
const sumanSingleProcessIntegrantsEmitter =
    global.sumanSingleProcessIntegrantsEmitter = new EE();
...
function init($module, $opts) {
    ...
    const testsuites = $module.exports._testsuites = $module.exports._testsuites || [];
    ...
    var exec = function () {
        // note that function may be conditionally redefined below
    };
                    ...
                    if (exportTests && matches) {
                        ...
                        setImmediate(function () {
                            ...
                            if (exportTests === true) { //TODO: if we use this, need to make work with integrants/blocked etc.
                                ...
                                $module.exports._testsuites.push(function ($argz) {
    ...
    start.skip = function (desc, opts, cb) {
