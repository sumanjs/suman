...
exports.IDefObjCtx = define_options_classes_1.DefineObjectContext;
var define_options_classes_2 = require("./test-suite-helpers/define-options-classes");
exports.IDefObjTestCase = define_options_classes_2.DefineObjectTestCase;
var define_options_classes_3 = require("./test-suite-helpers/define-options-classes");
exports.IDefObjAllHook = define_options_classes_3.DefineObjectAllHook;
var define_options_classes_4 = require("./test-suite-helpers/define-options-classes");
exports.IDefObjEachHook = define_options_classes_4.DefineObjectEachHook;
...
exports.init = function ($module, $opts, sumanOptsOverride, confOverride) {
    ...
    var ret = {
        ...
        define: function (desc, f) {
            ...
            var defObj = new define_options_classes_5.DefineObjectContext(desc, start);
            if (f) {
