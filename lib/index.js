...
var cwd = process.cwd();
var projectRoot = global.projectRoot = global.projectRoot || sumanUtils.findProjectRoot(cwd);
...
if (sumanReporters.length < 1) {
    ...
    if (global.sumanOpts.useTAPOutput) {
        ...
        fn = require(path.resolve(__dirname + '/reporters/std-reporter'));
    }
...
>>>>>>> c1bc4d23ee411d04e6afd3a1f3f7d933d92f0e6d
