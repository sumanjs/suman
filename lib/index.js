...
function init($module, $opts) {
    ...
    console.error('ABC blocked=>',blocked);
            ...
            if (integrantsReady) {
                ...
                var integrantMessage = function (msg) {
                    if (msg.info === 'integrant-ready') {
                        integrantsFromParentProcess.push(msg.key);
                        oncePreVals[msg.key] = msg.val;
            ...
            if (err) {
                ...
                makeSuman($module, _interface, true, config, function (err, suman) {
                    ...
                    if (err) {
                        ...
                        console.error('ABC suman has been made.');

                        //pass oncePost so that we can use it later when we need to
                        suman.oncePost = oncePost;
                        suman.userData = {
