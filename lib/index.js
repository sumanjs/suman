...
function Runner(obj) {
    ...
    try {
        ...
        if (runOutputInNewTerminalWindow) {
            ...
            runner(fileOrDir, config, sumanGroup, grepFile, '*', runOnce);
...
function checkForArrayEquality(arr1, arr2) {
        ...
        integrantsFn = function (cb) {
            ...
            process.on('message', function (msg) {
                if (msg.info === 'integrant-ready') {
                    ...
                    if(checkForArrayEquality(integrants, integrantsFromParentProcess)){
