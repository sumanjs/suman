...
if (false) {
    ...
    var req_1 = Mod.prototype && Mod.prototype.require;
    Mod.prototype && (Mod.prototype.require = function () {
        var args = Array.from(arguments);
        var lastArg = args[args.length - 1];
        var ret = req_1.apply(this, arguments);
        return ret;
    });
}
var oncePostFn;
...
var execSuite = require('./exec-suite');
    ...
    if (usingRunner) {
        ...
        _suman._writeTestError = function (data, ignore) {
            ...
            if (data) {
                ...
                console.error(' => Suman implementation error => no data passed to _writeTestError. Please report.');
            }
        };
