...
function Server(obj) {
    ...
    if (os.platform() === 'win32') {
        execFile = 'start-server.bat';
        var n = cp.exec(execFile, [], {
            detached: true,
            env: {
                NODE_ENV: $NODE_ENV || process.env.NODE_ENV
            }
        ...
        //var n = cp.exec('open -b com.apple.terminal start-server.sh', [], {
        //    detached: true,
        //    env: {
        //        NODE_ENV: $NODE_ENV || process.env.NODE_ENV
        //    }
