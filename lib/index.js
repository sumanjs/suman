        ...
        describe: function () {
            ...
            integrantsFn(function (err) {
                if (err) {
                    ...
                    makeSuman($module, config, function (err, suman) {
                        ...
                        setImmediate(function () {  // allows for future possibility of multiple test suites referenced in the same file
                            if ($module.exports.wait === true) { //TODO: change this to suman.init config instead
