...
if (require.main === module) {
    throw new Error('=> Suman usage error => This file is not meant to be executed directly. You must be doing something wrong.');
}
var process = require('suman-browser-polyfills/modules/process');
var global = require('suman-browser-polyfills/modules/global');
global.sumanOpts = global.sumanOpts || {};
var util = require('util');
var Mod = require('module');
var req = Mod.prototype && Mod.prototype.require;
var inBrowser = false;
var _suman = global._suman = (global._suman || {});
try {
    window.module = {};
    ...
    global._suman = global._suman || {};
    inBrowser = global._suman.inBrowser = false;
}
if (global.sumanOpts.verbosity > 8) {
...
var oncePostFn;
var sumanRuntimeErrors = global.sumanRuntimeErrors = global.sumanRuntimeErrors || [];
...
var allOncePreKeys = global.oncePreKeys = [];
var allOncePostKeys = global.oncePostKeys = [];
var integrantsEmitter = global.integrantsEmitter = (global.integrantsEmitter || new EE());
var integProgressEmitter = global.integProgressEmitter = (global.integProgressEmitter || new EE());
var integContainer = global.integContainer = (global.integContainer || {});
var integProgressContainer = global.integProgressContainer = (global.integProgressContainer || {});
var iocEmitter = global.iocEmitter = (global.iocEmitter || new EE());
var iocContainer = global.iocContainer = (global.iocContainer || {});
var iocProgressContainer = global.iocProgressContainer = (global.iocProgressContainer || {});
var resultBroadcaster = global.resultBroadcaster = (global.resultBroadcaster || new EE());
var sumanReporters = global.sumanReporters = (global.sumanReporters || []);
var suiteResultEmitter = global.suiteResultEmitter = (global.suiteResultEmitter || new EE());
...
var cwd = process.cwd();
var projectRoot = global.projectRoot = global.projectRoot || su.findProjectRoot(cwd) || '/';
...
var sumanOptsFromRunner = global.sumanOpts || (process.env.SUMAN_OPTS ? JSON.parse(process.env.SUMAN_OPTS) : {});
var sumanOpts = global.sumanOpts = (global.sumanOpts || sumanOptsFromRunner);
var usingRunner = global.usingRunner = (global.usingRunner || process.env.SUMAN_RUNNER === 'yes');
var sumanConfig = require('./helpers/load-suman-config')(null);
if (!global.usingRunner && !_suman.viaSuman) {
...
>>>>>>> aeac6727cd17343b5e73ebec80a2b68898f598a3
    }
    else {
...
var init = function ($module, $opts) {
    ...
    if (opts.__expectedExitCode !== undefined && process.env.SUMAN_SINGLE_PROCESS !== 'yes') {
        var expectedExitCode = global.expectedExitCode = global.expectedExitCode || opts.__expectedExitCode;
    ...
    if (opts.timeout !== undefined && process.env.SUMAN_SINGLE_PROCESS !== 'yes') {
        var timeout = global.expectedTimeout = opts.timeout;
    ...
    var exportTests = (opts.export === true || singleProc || global._sumanIndirect);
    ...
    if (usingRunner) {
        global._writeTestError = function (data, options) {
    ...
    var start = function (desc, opts, arr, cb) {
        ...
        function onPreVals(vals) {
            clearTimeout(to);
            if (!inBrowser && !global.iocConfiguration || process.env.SUMAN_SINGLE_PROCESS === 'yes') {
                ...
                global.iocConfiguration = global.iocConfiguration || {};
            }
            makeSuman($module, _interface, true, sumanConfig, function (err, suman) {
                ...
                if (exportTests && matches) {
                    ...
                    return fatalRequestReply({
                        ...
                        global._writeTestError(' => Suman usage error => You have declared export:true in ' +
