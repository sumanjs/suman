...
if (os.platform() === 'win32') {
    ...
    debugger;
    n = cp.exec('start powershell.exe -NoExit "Get-Content C:\\Users\\denman\\WebstormProjects\\suman-private\\suman\\stdio-logs\\test-stderr.log -Wait"', function(err,stdout,stderr){
