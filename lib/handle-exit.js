...
function handleExit(suman, testErrors, errors) {
    ...
    process.on('exit', function (code) {
        ...
        if (global.testStderrStrmPath /*process.argv.indexOf('--runner') < 0 && process.argv.indexOf('--rnr') < 0*/) {
            //global._writeError('\n\n<<< Suman end run <<<\n\n\n\n\n\n\n\n\n');
        ...
        if (errors.length > 0) {
            ...
            errors.forEach(function(e){
                console.log(typeof e === 'string' ? e :util.inspect(e));
            });
        ...
        // setImmediate(function () {  //TODO: note => does not work
        //     process.exit(code);
        // });
