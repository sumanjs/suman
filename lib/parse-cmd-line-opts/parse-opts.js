...
const options = [
	...
	},
	{
		names: ['use-babel'],
		type: 'bool',
		help: 'Suman will download and install the babel dependencies necessary to transpile on this machine.'
	},
	{
		names: ['use-istanbul'],
		type: 'bool',
		help: 'Suman will download and install the Istanbul dependencies necessary to run test coverage on this machine.'
	},
	{
		names: ['errors-only'],
		type: 'bool',
	...
	},
	{
		names: ['no-run'],
		type: 'bool',
		help: 'When --transpile is set to true, no-run prevents Suman from executing the resulting tests.'
	},
	{
	...
	// 	names: ['optimized', 'o'],
	// 	type: 'bool',
	// 	help: 'Optimized transpilation for tests.'
	// },
	{
		names: ['config', 'cfg'],
		type: 'string',
...
if (process.env.SUMAN_DEBUG == 'on' || opts.vverbose) {
