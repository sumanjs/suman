...
const options = [
    ...
    {
        names: ['watch-project', 'wp'],
        type: 'bool',
        help: 'Watch all project files and upon changes run the script/command given by the properties of "watchProject" in your suman.conf.js file.'
    },
    {
