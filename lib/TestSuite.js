    ...
    TestSuiteMaker.new = function (data) {  //TODO: need to validate raw data...
        ...
        function TestSuite(obj) {
            ...
            const before = function (desc, before) {
                ...
                const obj = handleExtraOpts.handleOptionalDesc(desc, before);
            ...
            const after = function (desc, after) {
                handleSetupComplete(this);
                const obj = handleExtraOpts.handleOptionalDesc(desc, after);
                //TODO: add timeout option
                this.getAfters().push({
                    ctx: this,
                    desc: obj.desc || obj.fn.name,
            ...
            const beforeEach = function (desc, aBeforeEach) {
                handleSetupComplete(this);
                const obj = handleExtraOpts.handleOptionalDesc(desc, aBeforeEach);
                //TODO: add timeout option
            ...
            const afterEach = function (desc, aAfterEach) {
                handleSetupComplete(this);
                const obj = handleExtraOpts.handleOptionalDesc(desc, aAfterEach);
                //TODO: add timeout option
            ...
            describe = this.context = function (desc, opts, cb) {
                ...
                if (utils.isArrowFunction(cb) || utils.isGeneratorFn()) { //TODO: need to check for generators or async/await as well
                    throw new Error('You cannot use an arrow/generator functions with describe callbacks; however, you may use arrow functions everywhere else, except describes.')
                }
