        ...
        function TestSuite(obj) {
            ...
            it = function (desc, opts, cb) {
                ...
                testData = {
                    ...
                    delay: opts.delay,
                    type: 'it-standard',
                    setTimeout: null, // gets defined later
            ...
            describe = this.context = function (desc, opts, cb) {
                ...
                suite.__proto__._run = function run(callback) {  //TODO: put run on the proto
