...
module.exports = opts => {
  ...
  try {
    ...
    debugInit(' => During --init, we have found a pre-existing suman.conf.js file at path ' +
      'file at path => ', potentialPathToConf);
  }
  catch (err) {
    debugInit(' => Did not find a suman.conf.js (a good thing, since we are initting) ' +
