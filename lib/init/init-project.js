...
module.exports = (opts) => {
	...
	async.parallel({
		...
		console.log(' => Notice the suman directory in the root of your project. This directory houses log files used by Suman for debugging tests running' +
			'in child_processes as well as Suman helper files. Suman recommends moving the "suman" directory inside your test directory and renaming it _suman.' +
