...
module.exports = (opts) => {
    ...
    async.parallel({
        ...
        console.log(' => run "$ source ~/.bash_profile" to pick up a new line in your .bash_profile file.');
        console.log(' => If you are using an IDE, you may need to restart your IDE so it picks up new lines in your .bash_profile file.');
