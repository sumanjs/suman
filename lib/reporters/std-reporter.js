...
//README: note that for reference, all events are listed here, several are noop'ed because of this
...
module.exports = s => {
  ...
  console.log(' => Standard Suman reporter loaded.');
  ...
  s.on(events.TEST_CASE_FAIL, function (test) {
    ...
    if (global._suman.processIsRunner) {
