...
module.exports = {
    ...
    main: function main(suman) {
        ...
        function getAllBeforesEaches(test) {
            ...
            var bob = _.flatten(beforeEaches, true);
            return bob;
        }
        ...
        function getAllAfterEaches(test) {
            ...
            var bob = _.flatten(afterEaches, true);
            return bob;
        }
        ...
        function startSuite(finished) {
            ...
            function handleBeforeOrAfterEach(test, aBeforeOrAfterEach, cb) {
                ...
                suman.ctx.currentCtx.fn = cb;

                function makeCallback() {
                    suman.ctx.currentCtx.fn = null;
            ...
            function runTheTrap(test, cb) {
                ...
                var arr = getAllBeforesEaches(self);
                    ...
                    function doneWithBeforeEaches(err, results) {
                        ...
                        gracefulExit(results, function () {
                            ...
                            async.series([function (cb) {
                                ...
                                var arr = getAllAfterEaches(self);
