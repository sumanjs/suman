...
var handle_integrant_info_1 = require("./runner-helpers/handle-integrant-info");
...
var runSingleOrMultipleDirs = handle_multiple_processes_1.makeHandleMultipleProcesses(runnerObj, tableRows, messages, forkedCPs, beforeExitRunOncePost, exit);
var runAllTestsInSingleProcess = makeSingleProcess(runnerObj, messages, beforeExitRunOncePost, exit);
var runAllTestsInContainer = makeContainerize(runnerObj, messages, beforeExitRunOncePost, exit);
