...
var AllHookParam = (function (_super) {
    ...
    function AllHookParam(hook, assertCount, handleError, fini, timerObj, onTimeout) {
        ...
        _this.__timerObj = timerObj;
        _this.__onTimeout = onTimeout;
        return _this;
    }
    AllHookParam.prototype.ctn = function (err) {
        this.callbackMode ? this.__fini(null) : this.handleNonCallbackMode(err);
    };
    AllHookParam.prototype.pass = function (err) {
        this.callbackMode ? this.__fini(null) : this.handleNonCallbackMode(err);
    };
