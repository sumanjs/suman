...
Suman.prototype.acquire = function (cb) {
    ...
    this.deps.forEach(dep => {
        ...
        if (_.contains(constants.SUMAN_HARD_LIST, String(dep)) && String(dep) in this.iocConfiguration) {
        ...
        else if (_.contains(constants.CORE_MODULE_LIST, String(dep)) && String(dep) in this.iocConfiguration) {
        ...
        else if (_.contains(constants.CORE_MODULE_LIST, String(dep)) || _.contains(constants.SUMAN_HARD_LIST, String(dep))) {
...
Suman.prototype.once = once; // TODO what is this for?
