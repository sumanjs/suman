...
var find_suman_server_1 = require("./helpers/find-suman-server");
...
var Suman = (function () {
    ...
    Suman.prototype.logFinished = function ($exitCode, skippedString, cb) {
        ...
        if (_suman.usingRunner) {
            ...
            if (skippedString) {
                ...
                table_1.addRow('Test blocks skipped', suitesSkipped ? 'At least ' + suitesSkipped : '-', skippedSuiteNames.length > 0 ? suman_utils_1.default.customStringify(skippedSuiteNames) : '');
                ...
                table_1.addRow('--------------------------', '         ---', suman_utils_1.default.padWithXSpaces(33) + '-');
                ...
                table_1.addRow('--------------------------', suman_utils_1.default.padWithXSpaces(10) + '---', suman_utils_1.default.padWithXSpaces(33) + '-');
                table_1.addRow('Passing rate', passingRate);
                table_1.addRow('Actual time millis (delta)', deltaStrg, suman_utils_1.default.padWithXSpaces(33) + '-');
                table_1.addRow('Actual time seconds (delta)', deltaSeconds, suman_utils_1.default.padWithXSpaces(33) + '-');
                table_1.addRow('Total time millis (delta)', deltaTotalStr, suman_utils_1.default.padWithXSpaces(33) + '-');
                table_1.addRow('Total time seconds (delta)', deltaTotalSeconds, suman_utils_1.default.padWithXSpaces(33) + '-');
            }
    ...
    Suman.prototype.logResult = function (test) {
        ...
        var str = suman_utils_1.default.customStringify(data);
        str = str.replace(/(\r\n|\n|\r)/gm, '');
...
exports.makeSuman = function ($module, _interface, shouldCreateResultsDir, config, cb) {
    ...
    var server;
    try {
        server = find_suman_server_1.findSumanServer(null);
    }
    catch (err) {
