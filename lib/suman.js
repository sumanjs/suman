...
function logMessage(suman, msg) {

    if (typeof msg !== 'object') {
        throw new Error('msg is not an object-' + msg);
    }
    ...
    if (process.send) {
        ...
        fs.appendFileSync(suman.outputPath, json += ',');

        console.log('testId:', msg.test.testId, 'test result:', msg.test.error);
    }
