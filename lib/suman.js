...
Suman.prototype.logFinished = function ($exitCode, skippedString, cb) {
    ...
    if (_suman.usingRunner) {
        ...
        if (skippedString) {
            ...
            table_1.addRow('Actual time millis (delta)', deltaStrg, '                                   -');
            table_1.addRow('Actual time seconds (delta)', deltaSeconds, '                                   -');
            table_1.addRow('Total time millis (delta)', deltaTotalStr, '                                   -');
            table_1.addRow('Total time seconds (delta)', deltaTotalSeconds, '                                   -');
        }
