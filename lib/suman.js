...
Suman.prototype.logResult = function (test) {  //TODO: refactor to logTestResult
  ...
  if (global.sumanOpts.errors_only && test.dateComplete) {
    // since errors only and this test has completed, we ignore and don't write out result
    return;
  }

  // if (global.useTAPOutput) {
  //   // runner or not, either way we do the same thing - write TAP output to stdout
  //
  //   return;
  // }

  if (global.usingRunner && !global.useTAPOutput) {
