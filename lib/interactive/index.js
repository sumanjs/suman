...
function generateList (answers, onBackspace) {

  const dir = answers.firstAction;
...
function secondSet () {
  ...
  return inquirer.prompt(secondSetOfQuestions).then(function (obj) {
    return generateList(obj, secondSet).then(function (answers) {
