...
module.exports = function makePromise (opts, backspaceCB) {
  ...
  const _makePromise = makePromise.bind(null, opts, backspaceCB);

  return startGenerateCommand(opts, backspaceCB).then(function (obj) {

    if (obj.confirmStartGenerateCommand) {
