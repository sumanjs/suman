...
const fns = [
  ...
  function (cb) {
    ...
    return function (obj) {
      ...
      _interactiveDebug('choose dir obj =>', obj);
  ...
  function (cb) {
    ...
    return function (obj) {
      ...
      _interactiveDebug('get options obj =>', obj);
  ...
  function (cb) {
    ...
    return function (obj) {
      ...
      _interactiveDebug('get localOrGlobal obj =>', obj);
...
function run (opts, cb) {
  ...
  _interactiveDebug(
    '\nbeggining of run fn',
    '\n=> opts => ', opts,
    '\n=> fns => ', fns.map(f => String(f)),
    '\n=> completefns => ', completeFns.map(f => String(f))
  );
  ...
  // const l = completeFns.length;
  // const seed = completeFns[0] ? completeFns[0](runCB)(opts) : Promise.resolve(opts);
  ...
  fns.reduce(function (prev, curr) {
    ...
    return prev.then(function (obj) {
      ...
      if (!first) {
        ...
        if(completeFns.length < 2){
          s1.backspace = run.bind(null, obj, run);
        }
        else{
          s1.backspace = cb.bind(null, obj, run);
        }
  ...
  }, Promise.resolve(opts)).then(function (answers) {
