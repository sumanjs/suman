...
module.exports = function chooseDirs (opts, backspaceCB) {
  ...
  _interactiveDebug('CHOOSE DIR opts => ', opts);
    ...
    return inquirer.prompt([
      {
        ...
        validate: function (p) {
          _interactiveDebug('ppppp => ' + p);
          if (fs.statSync(p).isFile()) {
            _interactiveDebug('ppppp is file!! => ' + p);
            return true;
          }
      ...
      },
      {
        ...
        validate: function (p) {
          _interactiveDebug('zzzzzzz => ' + p);
          if (fs.statSync(p).isFile()) {
            _interactiveDebug('zzzzzzzzzz is file!! => ' + p);
            return true;
          }
          return 'Please select a file not a directory.';
        },
