...
const individualIntegrantEmitter = _suman.individualIntegrantEmitter = (_suman.individualIntegrantEmitter || new EE());
const integContainer = _suman.integContainer = (_suman.integContainer || new EE());
const integProgressContainer = _suman.integProgressContainer = (_suman.integProgressContainer || new EE());
