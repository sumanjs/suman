...
Note: Suman is not designed to run in the browser - it is designed for maximum performance of backend testing.
 ...
 * AVA test are not "node-able" - you *cannot* run them with node directly; Suman tests are node-able, which makes 
 ...
 ![alt text](https://raw.githubusercontent.com/ORESoftware/suman-private/dev/images/ava-probs.png "AVA problems")
